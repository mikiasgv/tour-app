<div wire:init="loadPopularGames" class="popular-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-12 border-b border-gray-800 pb-16">
    ...
    @empty
        ...
        <div class="game mt-8">
            ...
            <div class="block text-transparent text-lg bg-gray-700 leading-light mt-4">
                Title goes here
            </div>
            <div class="text-transparent text-lg bg-gray-700 rounded inline-block mt-3">
                Playstation 4, xbox
            </div>
        </div>
        @endforeach
